...
.defines(function(){
	...
	EntityEnemy_A = ig.Entity.extend({
		...
		init: function( x, y, settings ) {
			...
			ig.game.spawnEntity( EntityEnemy_A_gun, this.flip ? this.pos.x : this.pos.x+70, this.pos.y, {flip:this.flip, playAnim: false});
		},
		...
		shoot_bullet: function(){
			this.gun = ig.game.getEntitiesByType( EntityEnemy_A_gun )[0];
			var target = {
				x: 320,
				y: 320
			}
