...
.defines(function(){
	...
	EntityEnemy_C = ig.Entity.extend({
		...
		animSheet: new ig.AnimationSheet( 'media/ship_3_r2.png', 109, 65 ),
		...
		shoot_bullet: function(){
			...
			this.sfxShoot.play();
			ig.game.spawnEntity( EntityEnemyBullet, this.flip ? this.pos.x : this.pos.x+85, this.pos.y, {flip:this.flip, target:target, ship:ship} );
