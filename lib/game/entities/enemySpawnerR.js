...
EntityEnemySpawnerR = ig.Entity.extend({
	size: {x: 32, y: 32},
	...
	update: function() {
		if( this.roundTimer.delta() >= 2 ) {
			...
			if( this.canSummon && (this.base.enemyCount1 != this.base.maxEnemyCount) ) {
				switch (rand) {
					case 1: 
						ig.game.spawnEntity( EntityEnemy_A, this.pos.x, this.pos.y+10, {flip:true, health:this.base.wave} );
						break;
					case 2:
						ig.game.spawnEntity( EntityEnemy_B, this.pos.x+20, this.pos.y, {flip:true, health:this.base.wave} );
						break;
					case 3:
						ig.game.spawnEntity( EntityEnemy_C, this.pos.x+10, this.pos.y, {flip:true, health:this.base.wave} );
						break;
					default:
						ig.game.spawnEntity( EntityEnemy_C, this.pos.x+10, this.pos.y, {flip:true, health:this.base.wave} );
				}
